...
<header>
 ...
 <form action="result.php" method="POST">
  <div class="row">
    <div class="col">
      <input type="text" class="form-control" name="a" placeholder="сторона A">
      <input type="text" class="form-control" name="b" placeholder="сторона B">
      <input type="text" class="form-control" name="c" placeholder="сторона C">      
    </div>
  </div>
  <p></p>
